...
boot_record::boot_record(unsigned short bytes_per_sector, unsigned short numero_setores_por_cluster,
						unsigned short numero_setores_reservados, unsigned short numero_fat,
						unsigned short numero_entradas_diretorio, unsigned short numero_total_setores,
						unsigned short numero_setores_fat ){	
	// Escrita
